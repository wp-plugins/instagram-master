...
<table class="widefat fixed" cellspacing="0">
	...
	<tbody>
		<tr class="alternate">
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('../images/techgasp-instagrammaster-admin-widget-buttons.png', __FILE__); ?>" alt="<?php echo get_option('instagram_master_name'); ?>" align="left" width="300px" height="135px" style="padding:5px;"/></td>
		...
		<tr>
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('../images/techgasp-instagrammaster-admin-widget-embed-basic.png', __FILE__); ?>" alt="<?php echo get_option('instagram_master_name'); ?>" align="left" width="300px" height="135px" style="padding:5px;"/></td>
		...
		<tr class="alternate">
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('../images/techgasp-instagrammaster-admin-widget-photos.png', __FILE__); ?>" alt="<?php echo get_option('instagram_master_name'); ?>" align="left" width="300px" height="135px" style="padding:5px;"/></td>
		...
		<tr>
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('../images/techgasp-instagrammaster-admin-widget-embed-advanced.png', __FILE__); ?>" alt="<?php echo get_option('instagram_master_name'); ?>" align="left" width="300px" height="135px" style="padding:5px;"/></td>
