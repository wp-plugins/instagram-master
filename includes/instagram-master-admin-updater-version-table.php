...
<table class="widefat fixed" cellspacing="0">
	<thead>
		<tr>
			<th id="columnname" class="manage-column column-columnname" scope="col" width="350"><legend><h3><img src="<?php echo plugins_url('../images/techgasp-minilogo-16.png', __FILE__); ?>" style="float:left; height:16px; vertical-align:middle;" /><?php _e('&nbsp;Plugin', 'instagram_master'); ?></h3></legend></th>
...
$instagram_master_plugin_slug = 'instagram-master/instagram-master.php';
	echo '<a class="button-primary" href="'.wp_nonce_url( self_admin_url('update.php?action=upgrade-plugin&plugin=') . $instagram_master_plugin_slug, 'upgrade-plugin_' . $instagram_master_plugin_slug) .'" title="Update">Update</a></td>';
}
?>
			</th>
		</tr>
...
<?php
if( is_multisite() ) {
echo get_site_option( 'instagram_master_name' );
}
else{
echo get_option( 'instagram_master_name' );
}
?>
			</b></h2></td>
...
<?php
if( is_multisite() ) {
echo '<h3>Version '.get_site_option('instagram_master_newest_version').'</h3>';
}
else{
